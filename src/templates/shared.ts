...
// CSS link tags for external stylesheets
export function getCssLinks(includePasteStyles = false): string {
  const links = [`<link rel="stylesheet" href="/styles/main.${CSS_VERSION}.css">`];
  if (includePasteStyles) {
    links.push(`<link rel="stylesheet" href="/styles/paste.${CSS_VERSION}.css">`);
  }
  return links.join("\n  ");
}
...
export function renderFooter(): string {
  ...
  return `<footer class="site-footer">
    <p>punt.sh • <a href="https://github.com/lance0/punt">GitHub</a> • <a href="https://ko-fi.com/lance0">Ko-fi</a></p>
  </footer>
...
export function getSharedStyles(): string {
  return `
    /* Base mobile overflow prevention */
    html {
